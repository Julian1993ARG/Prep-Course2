...
function mayoriaDeEdad(edad) {
  ...
  var edad = edad>=18 ? "Allowed":"Not allowed"
  return edad
}
...
function conection(status) {
  ...
  var status = status===1 ? "Online":
  status===2 ? "Away":"Offline"
  return status
}
...
function esVerdadero(valor){
  ...
  let x= valor? "Soy verdadero":"Soy falso"
  return x
}
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  var num= (numero<1000&&numero>99)? true:false
  return num
}
